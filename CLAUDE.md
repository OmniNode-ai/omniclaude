...
- User: `postgres`
- Password: `***REDACTED***` (available in `.env`)
...
psql "postgresql://postgres:***REDACTED***@192.168.86.200:5436/omninode_bridge"
```
...
4. ✅ Test connection: `PGPASSWORD="***REDACTED***" psql -h 192.168.86.200 -p 5436 -U postgres -d omninode_bridge -c "SELECT 1"`
...
3. Test connection: `PGPASSWORD="***REDACTED***" psql -h 192.168.86.200 -p 5436 -U postgres -d omninode_bridge -c "SELECT 1"`

**All passwords in `.env`:**
- `POSTGRES_PASSWORD=***REDACTED***` ← **Use this for psql**
- `DB_PASSWORD=***REDACTED***`
- `OMNINODE_BRIDGE_POSTGRES_PASSWORD=***REDACTED***`
