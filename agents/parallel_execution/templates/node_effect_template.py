        ...
        "operation_methods": [
            ...
            if success:
                ...
                "return_fields": [
                    ...
                    {
                        "name": "operation",
                        "value": "ConsulOperationType.REGISTER"
                    }
                ]
            }
        ]
...
def generate_node_effect_code(template_name: str, agent_name: str, task_id: str, recommendations: List[Dict]) -> str:
    ...
    operation_dispatch = []
    for op in template_config["operations"]:
        operation_dispatch.append(f'''            if operation == {node_name}OperationType.{op["name"]}:
    ...
    for op in template_config["operation_methods"]:
        ...
        operation_methods.append(f'{OPERATION_METHOD_TEMPLATE.format(
