...
class PRDAnalyzer:
    ...
    def _identify_external_systems(self, parsed_prd: ModelParsedPRD, decomposition_result: PRDDecompositionResult) -> List[str]:
    ...
    def _calculate_quality_baseline(self, parsed_prd: ModelParsedPRD, decomposition_result: PRDDecompositionResult) -> float:
