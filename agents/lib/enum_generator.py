...
class EnumGenerator:
    ...
    OPERATION_VERBS = {
        ...
        'validate', 'process', 'transform', 'analyze', 'compute',
        'aggregate', 'filter', 'sort', 'merge', 'split', 'join',
        'publish', 'subscribe', 'notify', 'send', 'receive',
        ...
        'enable', 'disable', 'configure', 'initialize', 'cleanup'
    }
