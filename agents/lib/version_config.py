...
class VersionConfig:
    ...
    def update_from_environment(self):
        ...
        self.onex_compliance_threshold = float(os.getenv("ONEX_COMPLIANCE_THRESHOLD", str(self.onex_compliance_threshold)))
        ...
        self.validation_timeout_seconds = int(os.getenv("VALIDATION_TIMEOUT_SECONDS", str(self.validation_timeout_seconds)))
