...
if bash -n /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for func in "${functions_to_check[@]}"; do
    if grep -q "^${func}()" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for pattern in "${patterns[@]}"; do
    if grep -q "$pattern" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for element in "${required_elements[@]}"; do
    if grep -q "$element" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
if grep -q "researched:" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for tech in "${technologies[@]}"; do
    if grep -q "$tech" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
if grep -q "is_error_recognized.*job_name.*step_name" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
if grep -q "research_error.*job_name.*step_name" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for element in "${doc_elements[@]}"; do
    if grep -qi "$element" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
for field in "${research_fields[@]}"; do
    if ! grep -q "$field" /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
...
if grep -q 'if \[ -n "\$research" \]; then' /Users/jonah/.claude/skills/ci-failures/fetch-ci-data; then
