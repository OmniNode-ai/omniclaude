...
Environment variables:
    LLM_CODER_URL: Qwen2.5-Coder-14B endpoint (default: http://192.168.86.201:8000)
    LLM_EMBEDDING_URL: GTE-Qwen2 embedding endpoint (default: http://192.168.86.201:8002)
    ...
    LLM_QWEN_72B_URL: Qwen2.5-72B large model endpoint (default: http://192.168.86.200:8100)
    LLM_VISION_URL: Qwen2-VL vision endpoint (default: http://192.168.86.200:8102)
    LLM_DEEPSEEK_R1_URL: DeepSeek-R1-Distill reasoning endpoint (optional, hot-swap)
    LLM_QWEN_14B_URL: Qwen2.5-14B general purpose endpoint (default: http://192.168.86.100:8200)
