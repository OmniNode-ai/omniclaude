...
SavingsMethod = Literal[
    "zero_marginal_api_cost",
    "pricing_manifest_delta",
    "offline_unavailable",
]
...
class SavingsCalculator:
    ...
    def calculate(
        ...
        *,
        ...
        if model_local not in self._models:
            return ModelSavingsEstimate(
                ...
                savings_method="offline_unavailable",
        ...
        if self._model_is_local(model_local):
            ...
            method: SavingsMethod = "zero_marginal_api_cost"
        else:
            local_cost = self._cost_usd(model_local, prompt_tokens, completion_tokens)
            method = "pricing_manifest_delta"
