...
TOPIC_CODE_ANALYSIS_REQUESTED = "onex.cmd.omniintelligence.code-analysis.v1"  # arch-topic-naming: ignore
TOPIC_CODE_ANALYSIS_COMPLETED = "onex.evt.omniintelligence.code-analysis-completed.v1"  # arch-topic-naming: ignore
TOPIC_CODE_ANALYSIS_FAILED = "onex.evt.omniintelligence.code-analysis-failed.v1"  # arch-topic-naming: ignore
