...
"""Canonical handler for the overseer_verify_tick skill orchestrator."""
...
class HandlerOverseerVerifyTickSkill:
    """Adapter that keeps overseer_verify_tick on the shared skill dispatch path."""
    ...
    async def handle(self, request: ModelSkillRequest) -> ModelSkillResult:
        ...
        if self._task_dispatcher is None:
            raise RuntimeError("task_dispatcher is required for overseer_verify_tick")
...
__all__ = ["HandlerOverseerVerifyTickSkill"]
