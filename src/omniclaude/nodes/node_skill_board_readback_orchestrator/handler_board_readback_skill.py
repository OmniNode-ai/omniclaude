...
"""Canonical handler for the board_readback skill orchestrator."""
...
class HandlerBoardReadbackSkill:
    """Adapter that keeps board_readback on the shared skill dispatch path."""
    ...
    async def handle(self, request: ModelSkillRequest) -> ModelSkillResult:
        ...
        if self._task_dispatcher is None:
            raise RuntimeError("task_dispatcher is required for board_readback")
...
__all__ = ["HandlerBoardReadbackSkill"]
