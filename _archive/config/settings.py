...
def load_env_files(project_root: Path, environment: str | None = None) -> None:
    """
...
class Settings(BaseSettings):
    ...
    intelligence_service_url: str | None = Field(
        default=None,
    ...
    omninode_bridge_postgres_password: str | None = Field(
        default=None, description="Legacy alias for postgres_password"
    )
    ...
    routing_adapter_host: str | None = Field(
        default=None,
        description=(
    ...
    def log_configuration(self, logger_instance: logging.Logger | None = None) -> None:
        """
