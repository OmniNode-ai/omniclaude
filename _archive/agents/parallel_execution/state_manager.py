...
class ModelCodePointer(BaseModel):
    ...
    class_name: str | None = Field(None, description="Class name if method")
...
class ModelErrorSuccessLink(BaseModel):
    ...
    intermediate_steps: int | None = None
    recovery_strategy: str | None = None
    stf_name: str | None = None  # State Transformation Function name
    stf_pointer: ModelCodePointer | None = None
...
class NodeStateSnapshotEffect:
    ...
    def __init__(self, db_layer: DatabaseIntegrationLayer | None = None):
...
class StateManager:
    ...
    def __init__(
        self,
        db_layer: DatabaseIntegrationLayer | None = None,
