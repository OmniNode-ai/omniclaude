...
class AgentConfig(BaseModel):
    ...
    intelligence_integration: IntelligenceIntegration | None = None
...
class AgentLoader:
    ...
    def __init__(self, config_dir: Path | None = None, enable_hot_reload: bool = True):
        """
    ...
    async def reload_agent(self, agent_name: str) -> LoadedAgent | None:
        """
