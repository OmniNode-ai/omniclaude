...
def get_agent_metadata(name: str) -> dict[str, Any] | None:
    """
...
class AgentRegistry:
    ...
    def __init__(self, agents_directory: str | None = None):
        """
    ...
    def get_agent_module_path(self, name: str) -> str | None:
        """
    ...
    def get_agent_module_name(self, name: str) -> str | None:
        """
...
def get_agent_module_name(name: str) -> str | None:
    """
