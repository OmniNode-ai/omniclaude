...
class TransformationEvent(BaseModel):
    ...
    transformation_overhead_ms: float | None = None  # Target: <50ms
    agent_load_time_ms: float | None = None
...
class AgentTransformationTracker:
    ...
    async def track_transformation(
        ...
        capabilities_inherited: list[str] | None = None,
        context_preserved: dict[str, Any] | None = None,
        routing_confidence: float | None = None,
        task_id: str | None = None,
        agent_definition_path: str | None = None,
    ...
    async def print_metrics_summary(self):
        ...
        print(f"\n{'='*80}")
        print("🔄 Agent Transformation Metrics Summary")
        print(f"{'='*80}")
        ...
        print(
            f"Threshold Compliance: {metrics.threshold_compliance_rate:.2%} "
        ...
        print(
            f"Most Common Transformation: {metrics.most_common_transformation[0]} → "
    ...
    async def _log_to_trace_logger(self, event: TransformationEvent):
        ...
        message = (
            ...
            f"confidence: {event.routing_confidence:.2%})"
            if event.routing_confidence
...
_transformation_tracker: AgentTransformationTracker | None = None
