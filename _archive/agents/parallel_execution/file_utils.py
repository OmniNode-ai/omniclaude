...
class FileUtils:
    ...
    def create_backup(self, file_path: str, backup_dir: str | None = None) -> str:
    ...
    def clean_directory(
        self, directory_path: str, keep_pattern: str | None = None
    ) -> int:
...
class BackupManager:
    ...
    def list_backups(self, file_basename: str | None = None) -> list[dict[str, Any]]:
    ...
    def restore_backup(self, backup_path: str, target_path: str | None = None) -> str:
