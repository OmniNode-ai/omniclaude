...
class DebugStateManager:
    ...
    async def get_state_snapshot(self, snapshot_id: UUID) -> dict[str, Any] | None:
    ...
    async def get_workflow_snapshots(
        self, correlation_id: UUID, snapshot_type: str | None = None
    ) -> list[dict[str, Any]]:
    ...
    async def capture_success_state(
        ...
        execution_step: int | None = None,
        task_description: str | None = None,
        success_factors: dict[str, Any] | None = None,
    ) -> UUID:
        """
    ...
    async def complete_workflow_step(
        ...
        step_id: UUID,
        success: bool = True,
        error_event_id: UUID | None = None,
        success_event_id: UUID | None = None,
    ...
    async def get_recovery_patterns(
        self, error_type: str | None = None, min_confidence: float = 0.5
    ) -> list[dict[str, Any]]:
        """
