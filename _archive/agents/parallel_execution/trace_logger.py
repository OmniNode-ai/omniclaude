...
class TraceLogger:
    ...
    def __init__(self, trace_dir: str = "traces"):
        ...
        self._current_coordinator_trace: CoordinatorTrace | None = None
    ...
    async def start_agent_trace(
        self, agent_name: str, task_id: str, metadata: dict[str, Any] | None = None
    ) -> str:
    ...
    async def read_trace(self, trace_id: str) -> CoordinatorTrace | None:
