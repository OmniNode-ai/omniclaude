...
class InputValidator:
    ...
    async def validate_and_sanitize(
        self,
        user_input: str | dict | list | None = None,
    ...
    def _validate_rule(self, input_str: str, rule: ValidationRule) -> str | None:
    ...
    def _sanitize_input(
        self, user_input: str | dict | list, input_type: InputType
    ) -> Any:
...
async def validate_and_sanitize(
    user_input: str | dict | list, input_type: InputType, strict_mode: bool = True
) -> ValidationResult:
    """Validate and sanitize user input."""
