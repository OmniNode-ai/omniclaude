...
class QualityValidator:
    ...
    def __init__(
        self, config: CodegenConfig | None = None, enable_ml_validation: bool = True
    ):
        """
    ...
    ) -> dict[str, list[ast.Import | ast.ImportFrom]]:
        """Categorize imports into stdlib, third-party, local"""
        categorized: dict[str, list[ast.Import | ast.ImportFrom]] = {
            "stdlib": [],
            "third_party": [],
            "local": [],
        }
    ...
    def _is_import_order_correct(
        self, import_sections: dict[str, list[ast.Import | ast.ImportFrom]]
    ) -> bool:
