...
class AgentHistoryBrowser:
    ...
    def __init__(
        ...
        self.conn: psycopg_connection | None = None
    ...
    def get_run_detail(self, correlation_id: str | UUID) -> dict[str, Any] | None:
        """
...
"""
    ...
    def _show_commands(self, current_filter: str | None, current_limit: int):
