...
class RouterMetricsLogger:
    ...
    def __init__(
        ...
        self._thread_pool: asyncpg.Pool | None = None
    ...
    def _worker_loop(self):
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                time_since_write = (datetime.now(UTC) - last_write).total_seconds()
        ...
        for retry in range(self.max_retries):
            try:
                async with self._thread_pool.acquire() as conn:
                    ...
                    self.stats["last_write_time"] = datetime.now(UTC)
...
_metrics_logger: RouterMetricsLogger | None = None
