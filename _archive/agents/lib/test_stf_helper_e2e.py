...
async def test_complete_debugging_workflow(stf_helper):
    ...
    print("  Retrieved full STF details:")
...
"""
    ...
    print("  Quality score: 0.92 (improved from 0.90)")
    ...
    print("✓ Usage metrics tracked for applied solutions")
    print("✓ Improved solution stored for future use")
...
""",
    ...
    print("  ✓ Quality progression: 0.70 → 0.80 → 0.92")
    print("  ✓ Best solution promoted to top rank")
