...
class EmbeddingSearch:
    ...
    async def recommend_stfs(
        self, error_text: str, error_type: str | None = None, limit: int = 5
    ) -> list[dict[str, Any]]:
        """
...
async def find_similar_errors(
    error_text: str, error_type: str | None = None, limit: int = 10
) -> list[SimilarityResult]:
    """Find similar errors based on semantic similarity."""
...
async def recommend_stfs_for_error(
    error_text: str, error_type: str | None = None, limit: int = 5
) -> list[dict[str, Any]]:
    """Recommend STFs based on similar error patterns."""
