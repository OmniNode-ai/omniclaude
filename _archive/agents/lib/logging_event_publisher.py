...
class LoggingEventPublisher:
    ...
    def _validate_context_size(self, context: dict[str, Any] | None) -> None:
        """
    ...
    def _sanitize_context(
        self, context: dict[str, Any] | None, _depth: int = 0, _max_depth: int = 10
    ) -> dict[str, Any]:
        """
...
_global_publisher: LoggingEventPublisher | None = None
