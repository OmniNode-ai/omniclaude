...
class PerformanceMonitor:
    ...
    def get_phase_metrics(self, phase: str) -> PerformanceMetrics | None:
    ...
    def clear_metrics(self, phase: str | None = None):
...
def get_phase_metrics(phase: str) -> PerformanceMetrics | None:
    """Get performance metrics for a specific phase."""
