...
class AlertChannel:
    ...
    severity_filter: set[AlertSeverity] | None = None
    enabled: bool = True
...
class AlertManager:
    ...
    async def process_alert(
        self, alert: MonitoringAlert, escalation_policy: str | None = None
    ) -> ManagedAlert:
    ...
    def _find_duplicate_alert(self, alert: MonitoringAlert) -> ManagedAlert | None:
    ...
    async def acknowledge_alert(
        ...
        async with self._lock:
            ...
            managed_alert.acknowledged_at = datetime.now(UTC)
    ...
    async def resolve_alert(
        ...
        async with self._lock:
            ...
            managed_alert.resolved_at = datetime.now(UTC)
    ...
    async def suppress_alert(
        self, alert_id: str, duration_minutes: int, reason: str | None = None
    ) -> bool:
        ...
        async with self._lock:
            ...
            managed_alert.suppressed_until = datetime.now(UTC) + timedelta(
...
def get_alert_manager(config_path: Path | None = None) -> AlertManager:
...
async def process_alert(
    alert: MonitoringAlert, escalation_policy: str | None = None
) -> ManagedAlert:
    """Process an alert.
...
async def acknowledge_alert(
    alert_id: str, acknowledged_by: str, note: str | None = None
) -> bool:
    """Acknowledge an alert.
...
async def resolve_alert(alert_id: str, resolution_note: str | None = None) -> bool:
    """Resolve an alert.
