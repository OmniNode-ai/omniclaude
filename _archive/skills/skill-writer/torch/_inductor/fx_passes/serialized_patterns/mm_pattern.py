...
mm_default_2 = CallFunction(
    aten.mm.default, permute_default_1, KeywordArg("tangents_1")
)
mm_pattern_training = MultiOutputPattern([mm_default, mm_default_1, mm_default_2])


mm_pattern_inference = CallFunction(
    aten.mm.default, KeywordArg("mat1"), KeywordArg("mat2"), _users=0
)
