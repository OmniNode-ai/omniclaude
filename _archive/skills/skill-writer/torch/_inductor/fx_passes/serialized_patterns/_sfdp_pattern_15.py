...
where_self = CallFunction(
    aten.where.self, expand_default, full_default, div_Tensor, _users=2
)
...
_sfdp_pattern_15_training = MultiOutputPattern(
    [
        view_default_6,
        permute_default_6,
        permute_default_9,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_4, view_default_5)
_sfdp_pattern_15_inference = CallFunction(
...
convert_element_type_default_3 = CallFunction(
    prims.convert_element_type.default, view_default_8, Ignored()
)
...
view_default_12 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_12, Ignored())
_sfdp_pattern_15_half_training = MultiOutputPattern(
    [
        view_default_6,
        permute_default_6,
        permute_default_9,
...
view_default_5 = CallFunction(aten.view.default, clone_default_2, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_4, view_default_5)
_sfdp_pattern_15_half_inference = CallFunction(
    aten.view.default, bmm_default_1, Ignored(), _users=0
)
