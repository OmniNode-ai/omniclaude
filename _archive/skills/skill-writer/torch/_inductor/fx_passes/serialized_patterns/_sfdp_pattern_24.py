...
permute_default = CallFunction(
    aten.permute.default, view_default_1, Ignored(), _users=2
)
...
view_default_4 = CallFunction(
    aten.view.default, KeywordArg("value"), Ignored(), _users=2
)
...
_sfdp_pattern_24_training = MultiOutputPattern(
    [view_default_5, view_default_9, view_default_10, view_default_11, None]
)
...
bmm_default_1 = CallFunction(aten.bmm.default, div_Tensor, view_default_4)
_sfdp_pattern_24_inference = CallFunction(
...
bmm_default_1 = CallFunction(
    aten.bmm.default, convert_element_type_default, view_default_4
)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
neg_default = CallFunction(aten.neg.default, div_Tensor)
view_default_6 = CallFunction(
...
mul_Tensor = CallFunction(
    aten.mul.Tensor, convert_element_type_default_1, div_Tensor, _users=2
)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor, Ignored(), True)
fma_default = CallFunction(
    prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor
...
view_default_8 = CallFunction(
    aten.view.default, convert_element_type_default_2, Ignored(), _users=2
)
permute_default_2 = CallFunction(aten.permute.default, permute_default, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
...
permute_default_4 = CallFunction(aten.permute.default, bmm_default_4, Ignored())
view_default_10 = CallFunction(aten.view.default, permute_default_4, Ignored())
permute_default_5 = CallFunction(
    aten.permute.default, convert_element_type_default, Ignored()
)
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_5, view_default_6)
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
_sfdp_pattern_24_half_training = MultiOutputPattern(
    [view_default_5, view_default_9, view_default_10, view_default_11, None]
)
...
_sfdp_pattern_24_half_inference = CallFunction(
    aten.view.default, bmm_default_1, Ignored(), _users=0
)
