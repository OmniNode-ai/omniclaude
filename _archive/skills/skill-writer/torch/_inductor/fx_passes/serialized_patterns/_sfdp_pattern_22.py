...
_sfdp_pattern_22_training = MultiOutputPattern(
    [
        view_default_7,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_5, view_default_6)
view_default_7 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_22_inference = MultiOutputPattern(
...
view_default_15 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_15, Ignored())
_sfdp_pattern_22_bs1_training = MultiOutputPattern(
    [
        view_default_7,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_5, view_default_6)
view_default_7 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_22_bs1_inference = MultiOutputPattern(
    [view_default_7, permute_default_1, permute_default_3]
)
...
convert_element_type_default = CallFunction(
    prims.convert_element_type.default, add_Tensor, Ignored()
)
view_default_3 = CallFunction(
    aten.view.default, convert_element_type_default, Ignored()
)
...
amax_default = CallFunction(
    aten.amax.default, convert_element_type_default_1, Ignored(), True
)
...
expand_default_2 = CallFunction(
    aten.expand.default, convert_element_type_default_2, Ignored()
)
view_default_5 = CallFunction(aten.view.default, expand_default_2, Ignored(), _users=2)
permute_default_3 = CallFunction(
    aten.permute.default, KeywordArg("value"), Ignored(), _users=2
...
mul_Tensor = CallFunction(
    aten.mul.Tensor, convert_element_type_default_3, div_Tensor, _users=2
)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor, Ignored(), True)
fma_default = CallFunction(
    prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor
...
view_default_10 = CallFunction(
    aten.view.default, convert_element_type_default_4, Ignored()
)
view_default_11 = CallFunction(aten.view.default, view_default_10, Ignored())
...
convert_element_type_default_6 = CallFunction(
    prims.convert_element_type.default, convert_element_type_default_5, Ignored()
)
view_default_12 = CallFunction(
    aten.view.default, convert_element_type_default_6, Ignored(), _users=2
)
permute_default_5 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_12, permute_default_5)
view_default_13 = CallFunction(aten.view.default, bmm_default_3, Ignored())
...
view_default_15 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_15, Ignored())
_sfdp_pattern_22_half_training = MultiOutputPattern(
    [
        view_default_7,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_5, view_default_6)
view_default_7 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_22_half_inference = MultiOutputPattern(
    [view_default_7, permute_default_1, permute_default_3]
)
...
view_default_15 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_15, Ignored())
_sfdp_pattern_22_half_bs1_training = MultiOutputPattern(
    [
        view_default_7,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_5, view_default_6)
view_default_7 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_22_half_bs1_inference = MultiOutputPattern(
    [view_default_7, permute_default_1, permute_default_3]
)
