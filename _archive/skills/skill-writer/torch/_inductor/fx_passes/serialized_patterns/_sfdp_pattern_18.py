...
where_self = CallFunction(
    aten.where.self, KeywordArg("causal_mask"), div_Tensor, full_default_1, _users=2
)
...
fma_default = CallFunction(
    prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor_4
)
scalar_tensor_default = CallFunction(
...
where_self_1 = CallFunction(
    aten.where.self, KeywordArg("causal_mask"), fma_default, scalar_tensor_default
)
...
_sfdp_pattern_18_training = MultiOutputPattern(
    [
        view_default_5,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_inference = MultiOutputPattern(
    [view_default_5, permute_default_1, permute_default_3]
)
...
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_11, Ignored())
_sfdp_pattern_18_bs1_training = MultiOutputPattern(
    [
        view_default_5,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_bs1_inference = MultiOutputPattern(
    [view_default_5, permute_default_1, permute_default_3]
)
...
where_self = CallFunction(
    aten.where.self, KeywordArg("causal_mask"), div_Tensor, full_default_1
)
convert_element_type_default = CallFunction(
    prims.convert_element_type.default, where_self, Ignored(), _users=2
)
...
convert_element_type_default_4 = CallFunction(
    prims.convert_element_type.default, mul_Tensor_3, Ignored()
)
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_half_inference = MultiOutputPattern(
    [view_default_5, permute_default_1, permute_default_3]
)
...
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_11, Ignored())
_sfdp_pattern_18_half_bs1_training = MultiOutputPattern(
    [
        view_default_5,
        permute_default_1,
        permute_default_3,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_half_bs1_inference = MultiOutputPattern(
    [view_default_5, permute_default_1, permute_default_3]
)
