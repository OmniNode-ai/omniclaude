...
mm_default_1 = CallFunction(
    aten.mm.default, permute_default_1, KeywordArg("tangents_1")
)
mul_Scalar_2 = CallFunction(aten.mul.Scalar, mm_default_1, KeywordArg("alpha"))
addmm_pattern_training = MultiOutputPattern(
    [addmm_default, view_default, mul_Scalar_1, mul_Scalar_2, None, None]
)


addmm_pattern_inference = CallFunction(
    aten.addmm.default,
    KeywordArg("input"),
    KeywordArg("mat1"),
    KeywordArg("mat2"),
