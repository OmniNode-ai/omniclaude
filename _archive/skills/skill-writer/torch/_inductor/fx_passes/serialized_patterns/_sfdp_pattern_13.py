...
fma_default = CallFunction(
    prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor_4, _users=2
)
...
_sfdp_pattern_13_inference = CallFunction(
    aten.bmm.default, div_Tensor, KeywordArg("value"), _users=0
)
...
convert_element_type_default_5 = CallFunction(
    prims.convert_element_type.default, fma_default, Ignored(), _users=2
)
permute_default_2 = CallFunction(aten.permute.default, permute_default, Ignored())
...
_sfdp_pattern_13_half_training = MultiOutputPattern(
    [bmm_default_1, bmm_default_3, permute_default_4, bmm_default_5, None]
)
...
_sfdp_pattern_13_half_inference = CallFunction(
    aten.bmm.default, convert_element_type_default_1, KeywordArg("value"), _users=0
)
