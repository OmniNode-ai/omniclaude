...
clone_default_1 = CallFunction(
    aten.clone.default, expand_default_2, memory_format=torch.contiguous_format
)
...
where_self = CallFunction(
    aten.where.self, expand_default, full_default, view_default_3, _users=2
)
...
clone_default_2 = CallFunction(
    aten.clone.default, expand_default_4, memory_format=torch.contiguous_format
)
...
_sfdp_pattern_20_training = MultiOutputPattern(
    [
        view_default_6,
        permute_default_6,
        permute_default_9,
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_4, view_default_5)
_sfdp_pattern_20_inference = CallFunction(
...
view_default_12 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_12, Ignored())
_sfdp_pattern_20_half_training = MultiOutputPattern(
    [
        view_default_6,
        permute_default_6,
        permute_default_9,
...
view_default_5 = CallFunction(aten.view.default, clone_default_2, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_4, view_default_5)
_sfdp_pattern_20_half_inference = CallFunction(
    aten.view.default, bmm_default_1, Ignored(), _users=0
)
