...
from typing_extensions import Never, ParamSpec, Self, TypeIs, assert_never, override
    ...
    def create(
        ...
        if split == -1:
            ...
            if split_reduction:
                ...
                assert isinstance(
                    split_reduction.data, Reduction
...
class FlexibleLayout(Layout):
    ...
    def assert_free_symbol_uses_unchanged(self, name: str, value: IterateExprs) -> None:
        for unbacked_only in [True, False]:
            ...
            assert (
                new_free_symbols == old_free_symbols
...
class ExternKernel(InputsKernel):
    ...
    @classmethod
    def process_kernel(cls, kernel: _OpOverloads, *args: Any, **kwargs: Any) -> tuple[
        Any,
        list[Any],
        list[Any],
