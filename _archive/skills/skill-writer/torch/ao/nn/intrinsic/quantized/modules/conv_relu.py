...
class ConvReLU1d(nnq.Conv1d):
    ...
    def from_reference(cls, ref_qconv, output_scale, output_zero_point):
        assert (
            type(ref_qconv) is not torch.ao.nn.intrinsic.ConvBnReLU1d
...
class ConvReLU2d(nnq.Conv2d):
    ...
    def from_reference(cls, ref_qconv, output_scale, output_zero_point):
        assert (
            type(ref_qconv) is not torch.ao.nn.intrinsic.ConvBnReLU2d
...
class ConvReLU3d(nnq.Conv3d):
    ...
    def from_reference(cls, ref_qconv, output_scale, output_zero_point):
        assert (
            type(ref_qconv) is not torch.ao.nn.intrinsic.ConvBnReLU3d
