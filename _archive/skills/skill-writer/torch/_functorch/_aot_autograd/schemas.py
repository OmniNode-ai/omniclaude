...
from typing import TYPE_CHECKING, Any, NewType, Optional, Protocol, TypeVar, Union
...
from .. import config
from .functional_utils import ViewMetaSequence, _check_if_mutation_can_be_in_graph
...
class JointTraceFn(Protocol):
    ...
    def __call__(self, primals: list[FxValue], tangents: list[FxValue]) -> tuple[
