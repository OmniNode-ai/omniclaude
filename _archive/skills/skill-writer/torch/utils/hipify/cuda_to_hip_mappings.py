...
CUDA_TYPE_NAME_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("hipMemAllocationGranularity_flags", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemAllocationHandleType", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemGenericAllocationHandle_t", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemPoolPtrExportData", CONV_TYPE, API_DRIVER),
        ),
        (
...
CUDA_INCLUDE_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ('include "hip/device_functions.h', CONV_INCLUDE, API_RUNTIME),
        ),
        (
            "include <device_functions.h",
            ("include <hip/device_functions.h", CONV_INCLUDE, API_RUNTIME),
        ...
        (
            ...
            ('include "hip/driver_types.h', CONV_INCLUDE, API_RUNTIME),
        ),
        (
            "include <driver_types.h",
            ("include <hip/driver_types.h", CONV_INCLUDE, API_RUNTIME),
        ...
        (
            ...
            ('include "hip/library_types.h', CONV_INCLUDE, API_RUNTIME),
        ),
        (
            "include <library_types.h",
            ("include <hip/library_types.h", CONV_INCLUDE, API_RUNTIME),
...
CUDA_IDENTIFIER_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("hipHostRegisterReadOnly", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEMPOOL_ATTR_RELEASE_THRESHOLD",
            ("hipMemPoolAttrReleaseThreshold", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEMPOOL_ATTR_RESERVED_MEM_CURRENT",
            ("hipMemPoolAttrReservedMemCurrent", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEMPOOL_ATTR_RESERVED_MEM_HIGH",
            ("hipMemPoolAttrReservedMemHigh", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemPoolReuseAllowOpportunistic", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemPoolAttrUsedMemCurrent", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEMPOOL_ATTR_USED_MEM_HIGH",
            ("hipMemPoolAttrUsedMemHigh", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ACCESS_FLAGS_PROT_NONE",
            ("hipMemAccessFlagsProtNone", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ACCESS_FLAGS_PROT_READ",
            ("hipMemAccessFlagsProtRead", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ACCESS_FLAGS_PROT_READWRITE",
            ("hipMemAccessFlagsProtReadWrite", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ALLOCATION_TYPE_INVALID",
            ("hipMemAllocationTypeInvalid", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ALLOCATION_TYPE_MAX",
            ("hipMemAllocationTypeMax", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ALLOCATION_TYPE_PINNED",
            ("hipMemAllocationTypePinned", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ALLOC_GRANULARITY_MINIMUM",
            ("hipMemAllocationGranularityMinimum", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_ALLOC_GRANULARITY_RECOMMENDED",
            ("hipMemAllocationGranularityRecommended", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_HANDLE_TYPE_GENERIC",
            ("hipMemHandleTypeGeneric", CONV_TYPE, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipMemHandleTypeWin32Kmt", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_LOCATION_TYPE_DEVICE",
            ("hipMemLocationTypeDevice", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_LOCATION_TYPE_INVALID",
            ("hipMemLocationTypeInvalid", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_OPERATION_TYPE_MAP",
            ("hipMemOperationTypeMap", CONV_TYPE, API_DRIVER),
        ),
        (
            "CU_MEM_OPERATION_TYPE_UNMAP",
            ("hipMemOperationTypeUnmap", CONV_TYPE, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipArray3DGetDescriptor", CONV_MEM, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipHostGetDevicePointer", CONV_MEM, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipMemGetAllocationPropertiesFromHandle", CONV_MEM, API_DRIVER),
        ),
        (
        ...
        (
            ...
            ("hipMemRetainAllocationHandle", CONV_MEM, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipMemPoolExportToShareableHandle", CONV_MEM, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipMemPoolImportFromShareableHandle", CONV_MEM, API_DRIVER),
        ),
        ...
        (
            ...
            ("hipMemAccessFlagsProtReadWrite", CONV_MEM, API_RUNTIME),
        ),
        (
            "cudaMemLocationTypeDevice",
            ("hipMemLocationTypeDevice", CONV_MEM, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipMemPoolReuseAllowOpportunistic", CONV_MEM, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipMemoryTypeUnregistered", CONV_MEM, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipStreamCaptureStatusNone", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipStreamSetCaptureDependencies", CONV_STREAM, API_RUNTIME),
        ),
        (
            "cudaStreamUpdateCaptureDependencies",
            ("hipStreamUpdateCaptureDependencies", CONV_STREAM, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipDeviceGetGraphMemAttribute", CONV_TYPE, API_RUNTIME),
        ),
        ("cudaDeviceGraphMemTrim", ("hipDeviceGraphMemTrim", CONV_TYPE, API_RUNTIME)),
        (
            "cudaDeviceSetGraphMemAttribute",
            ("hipDeviceSetGraphMemAttribute", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphAddChildGraphNode",
            ("hipGraphAddChildGraphNode", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphAddDependencies",
            ("hipGraphAddDependencies", CONV_TYPE, API_RUNTIME),
        ),
        ("cudaGraphAddEmptyNode", ("hipGraphAddEmptyNode", CONV_TYPE, API_RUNTIME)),
        (
            "cudaGraphAddEventRecordNode",
            ("hipGraphAddEventRecordNode", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphAddEventWaitNode",
            ("hipGraphAddEventWaitNode", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphAddExternalSemaphoresWaitNode", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphAddMemAllocNode", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphAddMemcpyNode1D", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphAddMemcpyNodeFromSymbol",
            ("hipGraphAddMemcpyNodeFromSymbol", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphAddMemcpyNodeToSymbol",
            ("hipGraphAddMemcpyNodeToSymbol", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphChildGraphNodeGetGraph", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphEventRecordNodeGetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphEventRecordNodeSetEvent",
            ("hipGraphEventRecordNodeSetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphEventWaitNodeGetEvent",
            ("hipGraphEventWaitNodeGetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphEventWaitNodeSetEvent",
            ("hipGraphEventWaitNodeSetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecChildGraphNodeSetParams",
            ("hipGraphExecChildGraphNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecEventRecordNodeSetEvent",
            ("hipGraphExecEventRecordNodeSetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecEventWaitNodeSetEvent",
            ("hipGraphExecEventWaitNodeSetEvent", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphExecHostNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecKernelNodeSetParams",
            ("hipGraphExecKernelNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecMemcpyNodeSetParams",
            ("hipGraphExecMemcpyNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecMemcpyNodeSetParams1D",
            ("hipGraphExecMemcpyNodeSetParams1D", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphExecMemsetNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecNodeSetParams",
            ("hipGraphExecNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphHostNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphHostNodeSetParams",
            ("hipGraphHostNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateWithParams",
            ("hipGraphInstantiateWithParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodeCopyAttributes",
            ("hipGraphKernelNodeCopyAttributes", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodeGetAttribute",
            ("hipGraphKernelNodeGetAttribute", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodeGetParams",
            ("hipGraphKernelNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodeSetAttribute",
            ("hipGraphKernelNodeSetAttribute", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodeSetParams",
            ("hipGraphKernelNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        ("cudaGraphLaunch", ("hipGraphLaunch", CONV_TYPE, API_RUNTIME)),
        (
            "cudaGraphMemAllocNodeGetParams",
            ("hipGraphMemAllocNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemFreeNodeGetParams",
            ("hipGraphMemFreeNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemcpyNodeGetParams",
            ("hipGraphMemcpyNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemcpyNodeSetParams",
            ("hipGraphMemcpyNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemcpyNodeSetParams1D",
            ("hipGraphMemcpyNodeSetParams1D", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemcpyNodeSetParamsFromSymbol",
            ("hipGraphMemcpyNodeSetParamsFromSymbol", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemcpyNodeSetParamsToSymbol",
            ("hipGraphMemcpyNodeSetParamsToSymbol", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemsetNodeGetParams",
            ("hipGraphMemsetNodeGetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemsetNodeSetParams",
            ("hipGraphMemsetNodeSetParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeFindInClone",
            ("hipGraphNodeFindInClone", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeGetDependencies",
            ("hipGraphNodeGetDependencies", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeGetDependentNodes",
            ("hipGraphNodeGetDependentNodes", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphReleaseUserObject", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphRemoveDependencies",
            ("hipGraphRemoveDependencies", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphDebugDotFlagsEventNodeParams", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphDebugDotFlagsHandles", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphDebugDotFlagsHostNodeParams",
            ("hipGraphDebugDotFlagsHostNodeParams", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphDebugDotFlagsKernelNodeParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphDebugDotFlagsMemcpyNodeParams",
            ("hipGraphDebugDotFlagsMemcpyNodeParams", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphDebugDotFlagsMemsetNodeParams",
            ("hipGraphDebugDotFlagsMemsetNodeParams", CONV_TYPE, API_RUNTIME),
        ),
        ("cudaGraphDependencyType", ("hipGraphDependencyType", CONV_TYPE, API_RUNTIME)),
        (
            "cudaGraphDependencyTypeDefault",
            ("hipGraphDependencyTypeDefault", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphDependencyTypeProgrammatic",
            ("hipGraphDependencyTypeProgrammatic", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphDependencyType_enum",
            ("hipGraphDependencyType", CONV_TYPE, API_RUNTIME),
        ),
        ("cudaGraphEdgeData", ("hipGraphEdgeData", CONV_TYPE, API_RUNTIME)),
        ("cudaGraphEdgeData_st", ("hipGraphEdgeData", CONV_TYPE, API_RUNTIME)),
        (
            "cudaGraphExecUpdateError",
            ("hipGraphExecUpdateError", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphExecUpdateErrorNotSupported", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphExecUpdateResult", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphExecUpdateSuccess",
            ("hipGraphExecUpdateSuccess", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateError",
            ("hipGraphInstantiateError", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateFlagDeviceLaunch",
            ("hipGraphInstantiateFlagDeviceLaunch", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateFlagUpload",
            ("hipGraphInstantiateFlagUpload", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphInstantiateFlags", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateInvalidStructure",
            ("hipGraphInstantiateInvalidStructure", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphInstantiateParams", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphInstantiateResult", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphInstantiateSuccess",
            ("hipGraphInstantiateSuccess", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphKernelNodePortDefault",
            ("hipGraphKernelNodePortDefault", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphKernelNodePortProgrammatic", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemAttrReservedMemCurrent",
            ("hipGraphMemAttrReservedMemCurrent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemAttrReservedMemHigh",
            ("hipGraphMemAttrReservedMemHigh", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemAttrUsedMemCurrent",
            ("hipGraphMemAttrUsedMemCurrent", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemAttrUsedMemHigh",
            ("hipGraphMemAttrUsedMemHigh", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphMemAttributeType",
            ("hipGraphMemAttributeType", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphNodeTypeConditional", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphNodeTypeEventRecord", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeTypeExtSemaphoreSignal",
            ("hipGraphNodeTypeExtSemaphoreSignal", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeTypeExtSemaphoreWait",
            ("hipGraphNodeTypeExtSemaphoreWait", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphNodeTypeMemAlloc", CONV_TYPE, API_RUNTIME),
        ),
        (
            "cudaGraphNodeTypeMemFree",
            ("hipGraphNodeTypeMemFree", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphNodeTypeWaitEvent", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            "cudaLaunchHostFunc",
            ("hipLaunchHostFunc", CONV_EXEC, API_RUNTIME, HIP_UNSUPPORTED),
        ),
        (
            "cudaSetupArgument",
        ...
        (
            ...
            ("HIPBLASLT_MATMUL_DESC_A_SCALE_MODE", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATMUL_DESC_B_SCALE_MODE",
            ("HIPBLASLT_MATMUL_DESC_B_SCALE_MODE", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F",
            ("HIPBLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F", CONV_MATH_FUNC, API_BLAS),
        ),
        (
        ...
        (
            ...
            ("HIPBLASLT_MATMUL_DESC_POINTER_MODE", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0",
            ("HIPBLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3",
            ("HIPBLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_POINTER_MODE_DEVICE",
            ("HIPBLASLT_POINTER_MODE_DEVICE", CONV_NUMERIC_LITERAL, API_BLAS),
        ),
        (
            "CUBLASLT_POINTER_MODE_HOST",
            ("HIPBLASLT_POINTER_MODE_HOST", CONV_NUMERIC_LITERAL, API_BLAS),
        ),
        (
        ...
        (
            "cub::BlockRadixSort",
            ("hipcub::BlockRadixSort", CONV_SPECIAL_FUNC, API_RUNTIME),
        ),
        (
            "cub::Uninitialized",
...
CUDA_SPECIAL_MAP = collections.OrderedDict(
    [
        ...
        (
            "CUSPARSE_ORDER_COL",
            ("HIPSPARSE_ORDER_COL", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_ORDER_ROW",
        ...
        (
            ...
            ("HIPSPARSE_SPMM_CSR_ALG1", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_SPMM_CSR_ALG2",
            ("HIPSPARSE_SPMM_CSR_ALG2", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_SPMM_CSR_ALG3",
            ("HIPSPARSE_SPMM_CSR_ALG3", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_COOMV_ALG",
        ...
        (
            ...
            ("HIPSPARSELT_SPARSITY_50_PERCENT", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        ("cusparseComputeType", ("hipsparseLtComputetype_t", CONV_TYPE, API_SPECIAL)),
        (
            "CUSPARSE_COMPUTE_32F",
            ("HIPSPARSELT_COMPUTE_32F", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_COMPUTE_16F",
            ("HIPSPARSELT_COMPUTE_16F", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_COMPUTE_32I",
            ("HIPSPARSELT_COMPUTE_32I", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSE_COMPUTE_TF32",
            ("HIPSPARSELT_COMPUTE_TF32", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSELT_MATMUL_BIAS_POINTER",
            ("HIPSPARSELT_MATMUL_BIAS_POINTER", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSELT_MATMUL_ALG_DEFAULT",
            ("HIPSPARSELT_MATMUL_ALG_DEFAULT", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSELT_MATMUL_ALG_CONFIG_ID",
            ("HIPSPARSELT_MATMUL_ALG_CONFIG_ID", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
        ...
        (
            ...
            ("hipsparseLtMatDescriptor_t", CONV_TYPE, API_SPECIAL),
        ),
        ("cusparseLtInit", ("hipsparseLtInit", CONV_MATH_FUNC, API_SPECIAL)),
        (
            "cusparseLtStructuredDescriptorInit",
            ("hipsparseLtStructuredDescriptorInit", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtSpMMACompressedSize2",
            ("hipsparseLtSpMMACompressedSize2", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtSpMMACompress2",
            ("hipsparseLtSpMMACompress2", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulDescriptor_t",
            ("hipsparseLtMatmulDescriptor_t", CONV_TYPE, API_SPECIAL),
        ),
        ("cusparseLtMatmulPlan_t", ("hipsparseLtMatmulPlan_t", CONV_TYPE, API_SPECIAL)),
        (
            "cusparseLtMatmulAlgSelection_t",
            ("hipsparseLtMatmulAlgSelection_t", CONV_TYPE, API_SPECIAL),
        ),
        (
            "cusparseLtStructuredDescriptorInit",
            ("hipsparseLtStructuredDescriptorInit", CONV_MATH_FUNC, API_SPECIAL),
        ...
        (
            ...
            ("hipsparseLtDenseDescriptorInit", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulDescriptorInit",
            ("hipsparseLtMatmulDescriptorInit", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulDescSetAttribute",
            ("hipsparseLtMatmulDescSetAttribute", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulAlgSelectionInit",
            ("hipsparseLtMatmulAlgSelectionInit", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulAlgSetAttribute",
            ("hipsparseLtMatmulAlgSetAttribute", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulPlanInit",
            ("hipsparseLtMatmulPlanInit", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulGetWorkspace",
            ("hipsparseLtMatmulGetWorkspace", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulSearch",
            ("hipsparseLtMatmulSearch", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulAlgGetAttribute",
            ("hipsparseLtMatmulAlgGetAttribute", CONV_MATH_FUNC, API_SPECIAL),
        ),
        ("cusparseLtMatmul", ("hipsparseLtMatmul", CONV_MATH_FUNC, API_SPECIAL)),
        (
            "cusparseLtMatDescriptorDestroy",
            ("hipsparseLtMatDescriptorDestroy", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
            "cusparseLtMatmulPlanDestroy",
            ("hipsparseLtMatmulPlanDestroy", CONV_MATH_FUNC, API_SPECIAL),
        ),
        (
...
PYTORCH_SPECIFIC_MAPPINGS = collections.OrderedDict(
    [
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc_with_stream",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc_with_stream",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::getMemoryFraction",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::setMemoryFraction",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::getBaseAllocation",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::resetAccumulatedStats",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::resetAccumulatedStats",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::getCheckpointState",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::setCheckpointState",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::setCheckpointPoolState",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::setCheckpointPoolState",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::beginAllocateToPool",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::endAllocateToPool",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::recordAnnotation",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::pushCompileContext",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::popCompileContext",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::isHistoryEnabled",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::checkPoolLiveAllocations",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::checkPoolLiveAllocations",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::attachOutOfMemoryObserver",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::attachOutOfMemoryObserver",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::attachAllocatorTraceTracker",
                API_PYTORCH,
            ),
        ),
        (
            ...
            (
                "HIPCachingAllocatorMasqueradingAsCUDA::attachAllocatorTraceTracker",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::createOrIncrefPool",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::getPoolUseCount",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            (
                "hip::HIPCachingAllocatorMasqueradingAsCUDA::enablePeerAccess",
                API_PYTORCH,
            ),
        ),
        (
        ...
        (
            ...
            ("gloo/hip_allreduce_ring_chunked.h", API_PYTORCH),
        ),
        (
...
CAFFE2_SPECIFIC_MAPPINGS = collections.OrderedDict(
    [
        (
            ...
            ("PYTORCH_NO_CUDA_MEMORY_CACHING", API_CAFFE2),
        ),
...
C10_MAPPINGS = collections.OrderedDict(
    [
        ...
        (
            ...
            ("c10::hip::get_hip_check_suffix", API_C10),
        ),
