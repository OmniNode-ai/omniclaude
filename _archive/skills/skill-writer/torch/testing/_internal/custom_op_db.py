...
numpy_cube.register_autograd(
    numpy_cube_backward, setup_context=numpy_cube_setup_context
)
...
numpy_mul_scalar.register_autograd(
    numpy_mul_scalar_backward, setup_context=numpy_mul_scalar_setup_context
)
...
numpy_sort.register_autograd(
    numpy_sort_backward, setup_context=numpy_sort_setup_context
)
...
numpy_take.register_autograd(
    numpy_take_backward, setup_context=numpy_take_setup_context
)
...
numpy_view_copy.register_autograd(
    numpy_view_copy_backward, setup_context=numpy_view_copy_setup_context
)
...
numpy_split_copy.register_autograd(
    numpy_split_copy_backward, setup_context=numpy_split_copy_setup_context
)
...
def numpy_split_copy_with_int(
    x: Tensor, splits: Sequence[int], dim: int
