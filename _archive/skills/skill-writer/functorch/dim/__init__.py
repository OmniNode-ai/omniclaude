...
from ._dim_entry import DimEntry, _match_levels, ndim_of_levels
...
def dot(lhs: Any, rhs: Any, sum_dims: Any) -> Union[_Tensor, torch.Tensor]:
    ...
    assert (
        lhs_info.tensor is not None and rhs_info.tensor is not None
