...
class TestNamedTupleAPI(TestCase):
    ...
    def test_namedtuple_return(self):
        ...
        operators = [
            ...
            op(
                operators=["linalg_svd", "_linalg_svd"],
                input=(),
                names=("U", "S", "Vh"),
                hasout=True,
            ),
            op(
                operators=["slogdet", "linalg_slogdet"],
                input=(),
                names=("sign", "logabsdet"),
                hasout=True,
            ),
            op(
                operators=["_linalg_slogdet"],
                input=(),
                names=("sign", "logabsdet", "LU", "pivots"),
                hasout=True,
            ),
            op(operators=["qr", "linalg_qr"], input=(), names=("Q", "R"), hasout=True),
            op(operators=["geqrf"], input=(), names=("a", "tau"), hasout=True),
            op(
                operators=["triangular_solve"],
                input=(a,),
                names=("solution", "cloned_coefficient"),
                hasout=True,
            ),
            op(
                operators=["linalg_eig"],
                input=(),
                names=("eigenvalues", "eigenvectors"),
                hasout=True,
            ),
            op(
                operators=["linalg_eigh"],
                input=("L",),
                names=("eigenvalues", "eigenvectors"),
                hasout=True,
            ),
            op(
                operators=["_linalg_eigh"],
                input=("L",),
                names=("eigenvalues", "eigenvectors"),
                hasout=True,
            ),
            op(
                operators=["linalg_cholesky_ex"],
                input=(),
                names=("L", "info"),
                hasout=True,
            ),
            op(
                operators=["linalg_inv_ex"],
                input=(),
                names=("inverse", "info"),
                hasout=True,
            ),
            op(
                operators=["linalg_solve_ex"],
                input=(a,),
                names=("result", "info"),
                hasout=True,
            ),
            op(
                operators=["_linalg_solve_ex"],
                input=(a,),
                names=("result", "LU", "pivots", "info"),
                hasout=True,
            ),
            op(
                operators=["linalg_lu_factor"],
                input=(),
                names=("LU", "pivots"),
                hasout=True,
            ),
            op(
                operators=["linalg_lu_factor_ex"],
                input=(),
                names=("LU", "pivots", "info"),
                hasout=True,
            ),
            op(
                operators=["linalg_ldl_factor"],
                input=(),
                names=("LD", "pivots"),
                hasout=True,
            ),
            op(
                operators=["linalg_ldl_factor_ex"],
                input=(),
                names=("LD", "pivots", "info"),
                hasout=True,
            ),
            op(operators=["linalg_lu"], input=(), names=("P", "L", "U"), hasout=True),
            op(
                operators=["fake_quantize_per_tensor_affine_cachemask"],
                input=(0.1, 0, 0, 255),
                names=(
                    "output",
                    "mask",
            ...
            op(
                operators=["fake_quantize_per_channel_affine_cachemask"],
            ...
            op(
                operators=["_unpack_dual"],
                input=(0,),
                names=("primal", "tangent"),
                hasout=False,
            ),
            op(
                operators=["linalg_lstsq"],
                input=(a,),
                names=("solution", "residuals", "rank", "singular_values"),
                hasout=False,
            ),
            op(
                operators=["frexp"],
                input=(),
                names=("mantissa", "exponent"),
                hasout=True,
            ),
            op(
                operators=["lu_unpack"],
            ...
            op(
                operators=["histogram"],
                input=(1,),
                names=("hist", "bin_edges"),
                hasout=True,
            ),
            op(
                operators=["histogramdd"],
                input=(1,),
                names=("hist", "bin_edges"),
                hasout=False,
            ),
            op(
                operators=["_fake_quantize_per_tensor_affine_cachemask_tensor_qparams"],
                input=(
                    torch.tensor([1.0]),
            ...
            op(
                operators=["_fused_moving_avg_obs_fq_helper"],
                input=(
                    torch.tensor([1]),
                    torch.tensor([1]),
                    torch.tensor([0.1]),
            ...
            op(
                operators=["_linalg_det"],
                input=(),
                names=("result", "LU", "pivots"),
                hasout=True,
            ),
            op(operators=["aminmax"], input=(), names=("min", "max"), hasout=True),
            op(
                operators=["_lu_with_info"],
                input=(),
                names=("LU", "pivots", "info"),
                hasout=False,
            ),
