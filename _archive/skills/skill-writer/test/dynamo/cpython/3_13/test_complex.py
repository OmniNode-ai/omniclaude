...
class ComplexTest(__TestCase):
    ...
    def test_constructor(self):
        ...
        with self.assertRaisesRegex(
            TypeError, "second argument must be a number, not 'WithComplex'"
        ):
        ...
        self.assertRaisesRegex(
            TypeError, "can't take second arg if first is a string", complex, "1", 0
        )
        self.assertRaisesRegex(
            TypeError,
        ...
        self.assertRaisesRegex(
            TypeError, "second arg can't be a string", complex, 0, "1"
        )
