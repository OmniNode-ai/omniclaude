...
description: Log agent routing decisions to PostgreSQL for observability and learning. Records which agent was selected, confidence score, routing strategy, and reasoning.
---

# Log Routing Decision

This skill logs agent routing decisions to the PostgreSQL database for tracking, observability, and machine learning.
...
Logs to: `agent_routing_decisions`
...
Use the Bash tool to execute the logging script with your actual routing parameters:
...
This skill is part of the agent observability system. Logged decisions are:
