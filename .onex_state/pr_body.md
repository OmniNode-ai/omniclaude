## OMN-13097 Phase 4a — migrate 24 dispatch shims to the single-command `onex skill` receipt pattern

Part of epic **OMN-13089** (Skill Output Suppression — Quiet Receipts With Durable Capture). Plan: `docs/plans/2026-06-12-skill-output-suppression-plan.md` (Phase 4 item 1).
...
### What changed
- **SKILL.md**: declares `skill_kind: dispatch` (delegation-enforcer exemption, OMN-13096); body trimmed to the proven delegate shape — one command + result presentation.
...
Evidence-Source: a6fddee12c25070ef713c60a69ea45014dd5bcad
