...
def test_semantic_score_mapping():
    ...
    if set(actual_names) == set(expected_names):
        print(f"✓ PASS: Correct patterns passed filter")
    else:
    ...
    if scores == sorted(scores, reverse=True):
        print(f"✓ PASS: Patterns sorted by score descending")
    else:
        print(f"❌ FAIL: Patterns not sorted correctly")
        success = False
    ...
    if has_correct_metadata:
        print(f"✓ PASS: All patterns have correct metadata source")
    else:
        print(f"❌ FAIL: Patterns missing correct metadata")
        success = False
