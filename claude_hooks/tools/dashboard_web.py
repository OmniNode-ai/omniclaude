...
Simple web interface for OmniClaude system monitoring
"""
...
<body class="bg-gray-900 text-gray-100">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-lg shadow-xl p-6">
                    ...
                    <div id="issues-list" class="space-y-3">
                        <div class="text-gray-400 text-sm">No issues detected</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateDashboard(data) {
            ...
            document.getElementById('metric-hooks').textContent =
                health.total_events || 0;
            document.getElementById('metric-hooks-pending').textContent =
