...
```bash
PG_DSN: postgresql://postgres:omninode_remote_2024_secure@omninode-bridge-postgres:5436/omninode_bridge
...
- `POSTGRES_PASSWORD=omninode_remote_2024_secure` (only this one matches)
...
```bash
export PG_DSN="postgresql://postgres:omninode_remote_2024_secure@omninode-bridge-postgres:5436/omninode_bridge"
