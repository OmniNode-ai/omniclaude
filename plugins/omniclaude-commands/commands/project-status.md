---
name: project-status
description: Quick health dashboard for Linear projects with progress, velocity, blockers, and ETA metrics
tags: [linear, project-management, metrics, dashboard, velocity]
---
...
~/.claude/skills/linear-insights/project-status "$1" $2 $3 $4 2>&1
```
...
`~/.claude/skills/linear-insights/config.yaml`
