...
./velocity-estimate --project "MVP"

# All milestones overview
./velocity-estimate --all

# Include confidence intervals
./velocity-estimate --project "MVP" --confidence

# JSON output
./velocity-estimate --project "Beta" --json
```
...
./estimation-accuracy --project "MVP"
```
...
**Executables**:
- `./deep-dive` - Daily deep dive generator
- `./velocity-estimate` - Velocity and ETA calculator
- `./estimation-accuracy` - Estimation tracking
