...
# Resolve absolute path of this script, handling relative invocation (e.g. ./pre_tool_use_authorization_shim.sh).
...
onex_hook_gate PRE_TOOL_AUTHORIZATION_SHIM || exit 0
