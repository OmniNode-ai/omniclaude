...
# R10: OMNI_WORKTREES_DIR env var controls worktree root (default: ONEX_WORKTREES_ROOT, then $OMNI_HOME/omni_worktrees; empty when none is set).
...
OMNI_WORKTREES_DIR="${OMNI_WORKTREES_DIR:-${ONEX_WORKTREES_ROOT:-${OMNI_HOME:+${OMNI_HOME%/}/omni_worktrees}}}"  # empty when nothing names the root; never a machine path
