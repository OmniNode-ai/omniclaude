...
# --- Injection toggle (matches user-prompt-submit.sh) ---
...
# Gate: master injection toggle overrides per-feature flags
[[ "$INJECTION_ENABLED" != "true" ]] && SESSION_INJECTION_ENABLED="false"
...
# Gate: master injection toggle overrides per-feature flags
[[ "$INJECTION_ENABLED" != "true" ]] && TICKET_INJECTION_ENABLED="false"
TICKET_CONTEXT=""
ACTIVE_TICKET=""
...
if [[ "$INJECTION_ENABLED" != "true" ]]; then
    HANDSHAKE_INJECTION_ENABLED="false"
