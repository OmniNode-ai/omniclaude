...
| `--output-dir DIR` | Set output directory | `$LINEAR_INSIGHTS_OUTPUT_DIR` or `${HOME}/Code/omni_home/omni_save` |
...
|----------|-------------|---------|
| `LINEAR_INSIGHTS_OUTPUT_DIR` | Default output directory for saved reports | `${HOME}/Code/omni_home/omni_save` |
...
```json
{
  ...
  "output_file": "${HOME}/Code/omni_home/omni_save/DECEMBER_9_2025_DEEP_DIVE.md",
  "output_directory": "${HOME}/Code/omni_home/omni_save",
  "save_mode": false,
  "snapshot": {...},
  "data_sources": {
    "linear_mcp": true,
