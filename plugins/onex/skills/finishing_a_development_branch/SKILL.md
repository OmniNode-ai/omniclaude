...
PR_URL=$(gh pr create --title "<conventional commit>: <description> [OMN-XXXX]" --repo "$REPO" --body "$(cat <<'EOF'
## Summary
...
**Called by:**
- **multi-agent --mode sequential-with-review** (Step 7) - After all tasks complete
