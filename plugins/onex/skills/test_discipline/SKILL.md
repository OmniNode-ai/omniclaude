...
Unified testing methodology combining TDD workflow with anti-pattern detection.

- **TDD mode** (`--mode tdd`): Red-green-refactor cycle for writing new code test-first.
- **Audit mode** (`--mode audit`): Detect and fix testing anti-patterns in existing tests.
- **Full mode** (`--mode full`, default): Run TDD first, then audit for anti-patterns.

---

## TDD Mode (`--mode tdd`)

<!-- Absorbed from test-driven-development -->
...
<!-- Absorbed from testing-anti-patterns -->
...
Run TDD first, then audit for anti-patterns.

1. Follow the TDD red-green-refactor cycle for all new code.
