...
${CLAUDE_PLUGIN_ROOT}/skills/ci-failures/ci-quick-review "${1:-$PR_NUMBER}" 2>&1
```
...
### Core Workflow
- Use `${CLAUDE_PLUGIN_ROOT}/skills/ci-failures/ci-quick-review` script (not `fetch-ci-data`)
